...
public class MapperMethod {
    ...
    public Object execute(SqlSession sqlSession, Object[] args) {
        ...
        switch (command.getType()) {
            case INSERT: {
                //处理参数
                // 该方法主要的功能是获取@Param注解上的参数值,
                // 而实现方式便是通过参数解析器(ParamNameResolver),convertArgsToSqlCommandParam(args)方法实际上调用的是ParamNameResolver下的getNamedParams(args)方法。
                // 在分析该方法之前,先看看构造器都做了些什么操作。
    ...
    public static class SqlCommand {
        ...
        private MappedStatement resolveMappedStatement(Class<?> mapperInterface, String methodName,
            ...
            //如果找不到说明有可能在父类中，可以发现这里使用递归，直到从所有父类中查找，如果还是找不到返回null；
