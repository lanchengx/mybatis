...
public class XNode {
    ...
    /**
     * 构造器主要实现对象的实例化、字段属性的赋值。
     * 其中attributes 属性字段通过parseAttributes()方法解析node对象来获取，主要保存了节点包含的所有属性的键值对，
     * body属性字段通过parseBody()方法解析node对象来获取，主要处理当前节点的子元素，可能是文本内容，也可能是子标记，如果是文本内容，由getBodyData()方法处理，否则parseBody()方法处理。
     *
    ...
    /**
     * getXXXBody()系列方法主要是获取当前节点指定类型内容的方法。
     * @return
     */
    ...
    /**
     * getXXXAttribute()该系列方法主要是获取当前节点指定类型属性的方法，
     * @param enumType
     * @param name
     * @param <T>
     * @return
